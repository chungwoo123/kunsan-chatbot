...
# 테스트 이미지 경로 설정
test_data_dir = 'D:/lee/머신러닝_2024/식물 병해 인식/테스트 이미지'  # 변경 필요
...
for root, dirs, files in os.walk(test_data_dir):
    for file in files:
        if file.lower().endswith(('png', 'jpg', 'jpeg')):
            ...
            print(f"이미지: {file} - 예측된 질병: {predicted_class_name}")
...
# 테스트 이미지 경로 설정
test_data_dir = 'D:/lee/머신러닝_2024/식물 병해 인식/테스트 이미지'
